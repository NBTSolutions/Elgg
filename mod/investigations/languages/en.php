...
$english = array(
	...
	'investigations:widget:membership' => 'My Investigation Membership', //default: Investigation membership
	...
	'investigations:ingroup' => 'in the investigation',
    ...
    'river:reply:object:investigationforumtopic_text' => '%s replied on the Text Discussion %s',
    'river:reply:object:investigationforumtopic_image' => '%s replied on the Image Discussion %s',
    'river:reply:object:investigationforumtopic_map' => '%s replied on the Map Discussion %s',
    'river:reply:object:investigationforumtopic_graph' => '%s replied on the Graph Discussion %s',
